...
<head>
    <meta charset="UTF-8">
    <title>Receipt - Alamanda Houseboat</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 25px;">
            ...
            <div style="text-align: right;">
                <strong>INV :</strong> {{ $invoiceNumber }}
            </div>
        </div>
        ...
        <div class="total-section">
            ...
            <div class="total-row final">
                <span>JUMLAH YANG PERLU DIBAYAR</span>
        ...
        <div class="bank-info">
            ...
            <p style="margin-top: 10px; color: #28a745;"><strong>STATUS: <span class="status-paid">PAID</span></strong></p>
            @endif
        </div>
